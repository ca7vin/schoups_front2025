<template>
  <section id="products">
    ...
    <transition name="slide-right">
      ...
      >
        <div class="relative w-full sm:w-[400px] max-w-[90%] bg-white shadow-lg h-full p-6 overflow-y-auto pointer-events-auto">
          <button
            class="absolute top-4 right-4 text-gray-500 hover:text-[#D4338B] text-2xl font-bold"
            @click="closeDrawer"
            aria-label="Fermer"
          >
            &times;
...
const products = ref<Product[]>([
  ...
  // 5 autres produits identiques ici si tu veux
])
...
// Pour afficher les progress bars
