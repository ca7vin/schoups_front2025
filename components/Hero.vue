<template>
  <section
    id="hero"
    class="w-full min-h-screen flex flex-col lg:flex-row items-center justify-center overflow-hidden"
  >
    <!-- Texte -->
    <div
      v-if="bannerHero"
    ...
    <!-- Image en background -->
    <div
      class="w-full lg:w-1/2 h-[220px] sm:h-[300px] md:h-[400px] lg:h-full min-h-[200px] bg-no-repeat bg-center bg-cover"
